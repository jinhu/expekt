 ...
 */
class ExpectIterable<T>(subject: Iterable<T>?, flavor: Flavor, message: String?=null): ExpectAny<Iterable<T>>(subject, flavor, message) {
    ...
    val size: ExpectComparable<Int> get() {
        words.add("size")
        val expectInt = ExpectComparable(subject!!.count(), flavor, message)
